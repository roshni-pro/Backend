...
{
    [RoutePrefix("api/CatLogoUpload")]
    public class CatLogoUploadController : ApiController
    {
                ...
                try
                {
                    ...
                    if (HttpContext.Current.Request.Files.AllKeys.Any())
                    {
                        ...
                        if (httpPostedFile != null)
                        {
                            ...
                            var LogoUrl = Path.Combine(HttpContext.Current.Server.MapPath("~/images/catimages"), httpPostedFile.FileName);
