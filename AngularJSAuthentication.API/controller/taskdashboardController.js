...
(function () {
    ...
    taskdashboardController.$inject = ['$scope', '$http', 'ngAuthSettings', '$routeParams'];

    function taskdashboardController($scope, $http, ngAuthSettings, $routeParams) {
        ...
        $scope.drawWeekCircle = function (startdate, enddate) {
            ...
            $http.get(serviceBase + 'api/UserReport?startdate=' + startdate + '&enddate=' + enddate + '&id=' + $scope.id).then(function (results) {
                ...
                //});
                $http.get(serviceBase + 'api/BarChart?startdate=' + startdate + '&enddate=' + enddate).then(function (results) {
                    console.log("Data from server");
                    console.log(results);
                ...
                $http.get(serviceBase + 'api/PieChart?startdate=' + startdate + '&enddate=' + enddate).then(function (results) {
                    console.log("Data from server");
                    console.log(results);
                    //  $scope.barRows = results.data;
                    if (!$scope.float) {
