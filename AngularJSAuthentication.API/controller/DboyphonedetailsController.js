...
(function () {
    ...
    angular
        .module('app')
        .controller('DboyphonedetailsController', DboyphonedetailsController);

    DboyphonedetailsController.$inject = ['$scope', 'CityService', "$filter", "$http", "ngTableParams", 'FileUploader', '$modal', '$log'];

    function DboyphonedetailsController($scope, CityService, $filter, $http, ngTableParams, FileUploader, $modal, $log) {
        ...
        $scope.LineitemTotal = function (Cityid) {
            ...
            var url = serviceBase + 'api/DeliveryBoy/GetDboyDeviceInfo?Cityid=' + Cityid;
