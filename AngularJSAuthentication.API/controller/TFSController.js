...
(function () {
    ...
    angular
        .module('app')
        .controller('TFSweektimesheetController', TFSweektimesheetController);

    TFSweektimesheetController.$inject = ['$scope', 'tasktypesService', '$http', 'ngAuthSettings', 'ClientProjectService'];

    function TFSweektimesheetController($scope, tasktypesService, $http, ngAuthSettings, ClientProjectService) {
