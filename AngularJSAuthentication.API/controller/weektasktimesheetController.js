...
(function () {
    'use strict';
    app.controller('weektasktimesheetController', ['$scope', 'tasktypesService', '$http', 'ngAuthSettings', 'ClientProjectService', 'logger', function ($scope, tasktypesService, $http, ngAuthSettings, ClientProjectService, logger) {
        ...
        $scope.createWeekRows = function (startDate) {
            ...
            $http.get(serviceBase + 'api/WeekTaskEvent?startdate=' + todaystring).then(function (results) {
