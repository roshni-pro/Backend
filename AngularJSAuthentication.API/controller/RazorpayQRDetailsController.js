'use strict';
app.controller('RazorpayQRDetailsController', ['$scope', "$filter", "$http", "ngTableParams", '$modal', 'localStorageService', '$routeParams', function ($scope, $filter, $http, ngTableParams, $modal, localStorageService, $routeParams) {
    ...
    $scope.Getdata = function () {
        ...
        var url = serviceBase + "api/OnlineTransaction/GetRazorpayQRDetails?UploadId=" + $scope.upload;
    ...
    $scope.Comment = function (item) {
        ...
        modalInstance = $modal.open(
            {
                templateUrl: "RazorpayQRcomment.html",
                controller: "ModalInstanceRazorpayQRComment", resolve: { city: function () { return item } }
    ...
    $scope.selecthdfc = function (data) {
        ...
        $scope.paymentdetail = [];
        var url = serviceBase + "api/OnlineTransaction/OnchangeRazorpayQR?UploadId=" + $scope.upload + "&status=" + data.status;
        $http.get(url)
...
app.controller("ModalInstanceRazorpayQRComment", ["$scope", '$http', 'ngAuthSettings', "$modalInstance", "city", 'FileUploader', function ($scope, $http, ngAuthSettings, $modalInstance, city, FileUploader) {
    console.log("city");
