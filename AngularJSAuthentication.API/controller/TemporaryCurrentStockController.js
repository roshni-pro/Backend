...
(function () {
    ...
    angular
        .module('app')
        .controller('TemporaryCurrentStockController', TemporaryCurrentStockController);

    TemporaryCurrentStockController.$inject = ['CurrentStockService', 'WarehouseService', '$modal', '$scope', "$filter", "$http", "ngTableParams", "$interval"];

    function TemporaryCurrentStockController(CurrentStockService, WarehouseService, $modal, $scope, $filter, $http, ngTableParams, $interval) {
        ...
        //
      {
            ...
            $scope.getcurrentstock = function (WarehouseId) {
                ...
                CurrentStockService.getTempstockWarehousebased(WarehouseId).then(function (results) {
            ...
            $scope.oldStocks = function (pageno) {
                //
                $scope.OldStockData = [];
                var url = serviceBase + "api/CurrentStock/TempStockHistory" + "?ItemNumber=" + $scope.ItemNumber + "&list=" + $scope.itemsPerPage + "&page=" + pageno + "&WarehouseId=" + $scope.WarehouseId + "&StockId=" + $scope.StockId;
                $http.get(url).success(function (response) {
                    ...
                    $scope.OldStockData = response.TemporaryCurrentStockHistorydata;
            ...
            $scope.HistoryexportData = function () {
                ...
                var url = serviceBase + "api/CurrentStock/Export" + "?ItemNumber=" + $scope.ItemNumber + "&WarehouseId=" + $scope.WarehouseId;
                $http.get(url).success(function (response) {
...
//app.controller("AdjModalInstanceCtrlInventoryedit", ["$scope", '$http', 'ngAuthSettings', "$modalInstance", "inventory", function ($scope, $http, ngAuthSettings, $modalInstance, inventory) {
...
//}])
//app.controller('AdjEmptyCurrentController', ['CurrentStockService', 'WarehouseService', '$modal', '$scope', "$filter", "$http", "ngTableParams",
//    function (CurrentStockService, WarehouseService, $modal, $scope, $filter, $http, ngTableParams) {
