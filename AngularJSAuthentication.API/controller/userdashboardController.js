...
(function () {
    ...
    userdashboardController.$inject = ['$scope', '$http', "$filter", 'ngAuthSettings', '$routeParams', '$location'];

    function userdashboardController($scope, $http, $filter, ngAuthSettings, $routeParams, $location) {
        ...
        $scope.drawCircle = function (startdate, enddate, range) {
            ...
            $http.get(serviceBase + 'api/UserReport?startdate=' + startdate + '&enddate=' + enddate + '&id=' + $scope.userid).then(function (results) {
