'use strict';
app.controller('IRDraftController', ['$scope', 'WarehouseService', 'SearchPOService', 'supplierService', 'PurchaseODetailsService', "$filter", '$http', '$window', '$timeout', 'ngAuthSettings', "ngTableParams", '$modal',
    function ($scope, WarehouseService, SearchPOService, supplierService, PurchaseODetailsService, $filter, $http, $window, $timeout, ngAuthSettings, ngTableParams, $modal) {

        var detailIR = SearchPOService.getdrafteddata();
        ...
        $scope.savegr = function (data) {
            ...
            //if (data[0].IRType == "IR1") {
            //    for (var i = 0; i < data.length; i++) {
            //        if (data[i].MRP < data[i].Price1) {
            //            alert("Please Insert Correct Price");
            //            return;
            //        }
            //    }
            //}
            //else if (data[0].IRType == "IR2") {
            //    for (var i = 0; i < data.length; i++) {
            //        if (data[i].MRP < data[i].Price2) {
            //            alert("Please Insert Correct Price");
            //            return;
            //        }
            //    }
            //}
            //else if (data[0].IRType == "IR3") {
            //    for (var i = 0; i < data.length; i++) {
            //        if (data[i].MRP < data[i].Price3) {
            //            alert("Please Insert Correct Price");
            //            return;
            //        }
            //    }
            //}
            //else if (data[0].IRType == "IR4") {
            //    for (var i = 0; i < data.length; i++) {
            //        if (data[i].MRP < data[i].Price4) {
            //            alert("Please Insert Correct Price");
            //            return;
            //        }
            //    }
            //}
            //else if (data[0].IRType == "IR5") {
            //    for (var i = 0; i < data.length; i++) {
            //        if (data[i].MRP < data[i].Price5) {
            //            alert("Please Insert Correct Price");
            //            return;
            //        }
            //    }
            ...
            var url = serviceBase + "api/IR/DraftIRPost";
