'use strict';
app.controller('HDFCUPIDetailsController', ['$scope', "$filter", "$http", "ngTableParams", '$modal', 'localStorageService', '$routeParams', function ($scope, $filter, $http, ngTableParams, $modal, localStorageService, $routeParams) {
    ...
    $scope.Getdata = function () {
        ...
        var url = serviceBase + "api/OnlineTransaction/GethdfcUPIDetails?UploadId=" + $scope.upload;
    ...
    $scope.Comment = function (item) {
        ...
        modalInstance = $modal.open(
            {
                templateUrl: "HdfcUPIcomment.html",
                controller: "ModalInstancehdfcUPIComment", resolve: { city: function () { return item } }
    ...
    $scope.selecthdfcUPI = function (data) {
        
        $scope.paymentdetail = [];
        var url = serviceBase + "api/OnlineTransaction/OnchangeHDFCUPI?UploadId=" + $scope.upload + "&status=" + data.status;
        $http.get(url)
...
app.controller("ModalInstancehdfcUPIComment", ["$scope", '$http', 'ngAuthSettings', "$modalInstance", "city", 'FileUploader', function ($scope, $http, ngAuthSettings, $modalInstance, city, FileUploader) {
    console.log("city");
