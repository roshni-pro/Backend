...
(function () {
    ...
    assetsController.$inject = ['$scope', 'AssetsService', 'AssetsCategoryService', "$filter", "$http", "ngTableParams", '$modal'];

    function assetsController($scope, AssetsService, AssetsCategoryService, $filter, $http, ngTableParams, $modal) {
...
(function () {
    ...
    angular
        .module('app')
        .controller('ModalInstanceCtrlAssets', ModalInstanceCtrlAssets);

    ModalInstanceCtrlAssets.$inject = ["$scope", '$http', 'ngAuthSettings', "AssetsService", 'AssetsCategoryService', "$modalInstance", 'FileUploader', "assets"];

    function ModalInstanceCtrlAssets($scope, $http, ngAuthSettings, AssetsService, AssetsCategoryService, $modalInstance, FileUploader, assets) {
        console.log("assets");
...
(function () {
    ...
    angular
        .module('app')
        .controller('ModalInstanceCtrldeleteAssets', ModalInstanceCtrldeleteAssets);

    ModalInstanceCtrldeleteAssets.$inject = ["$scope", '$http', "$modalInstance", "AssetsService", 'ngAuthSettings', "assets"];

    function ModalInstanceCtrldeleteAssets($scope, $http, $modalInstance, AssetsService, ngAuthSettings, assets) {
