...
(function () {
    ...
    angular
        .module('app')
        .controller('daytimesheetController', daytimesheetController);

    daytimesheetController.$inject = ['$scope', 'tasktypesService', '$http', 'ngAuthSettings', 'ClientProjectService'];

    function daytimesheetController($scope, tasktypesService, $http, ngAuthSettings, ClientProjectService) {
        ...
        $scope.createdayRows = function (startDate) {
            ...
            $http.get(serviceBase + 'api/dayevents?startdate=' + todaystring).then(function (results) {
