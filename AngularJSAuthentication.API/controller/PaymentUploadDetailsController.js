'use strict';
app.controller('PaymentUploadDetailsController', ['$scope', "$filter", "$http", "ngTableParams", '$modal', 'localStorageService', '$routeParams', function ($scope, $filter, $http, ngTableParams, $modal, localStorageService, $routeParams) {
    ...
    $scope.Getdata = function () {
        ...
        var url = serviceBase + "api/OnlineTransaction/GetEpayDetails?UploadId=" + $scope.upload;
    ...
    $scope.Comment = function (item) {
        ...
        modalInstance = $modal.open(
            {
                templateUrl: "Epaycomment.html",
                controller: "ModalInstanceComment", resolve: { city: function () { return item } }
    ...
    $scope.selectepay = function (data) {

        $scope.paymentdetail = [];
        var url = serviceBase + "api/OnlineTransaction/OnchangeEpay?UploadId=" + $scope.upload  +"&status=" +  data.status;
        $http.get(url)
...
app.controller("ModalInstanceComment", ["$scope", '$http', 'ngAuthSettings', "$modalInstance", "city", 'FileUploader', function ($scope, $http, ngAuthSettings, $modalInstance, city, FileUploader) {
    console.log("city");
