'use strict'
app.controller('GrowthDashboardController', ['$scope', '$http', '$modal', "$filter", "GrowthDashboardService", 'WarehouseService',
    function ($scope, $http, $modal, $filter, GrowthDashboardService, WarehouseService) {
        ...
        $scope.initialize = function () {
            ...
            WarehouseService.getwarehouse().then(function (result) {
...
app.factory("GrowthDashboardService", function ($http, ngAuthSettings) {
    var service = {};
