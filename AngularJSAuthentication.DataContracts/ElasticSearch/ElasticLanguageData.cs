...
namespace AngularJSAuthentication.DataContracts.ElasticLanguageSearch
{
    public class ElasticLanguageData
    {
        public string englishtext { get; set; }
        public string converttext { get; set; }
    }

    public class ElasticLanguageDataRequest
    {
        public string englishtext { get; set; }
        public string converttext { get; set; }
    ...
    public class ElasticLanguageResult
    {
    ...
    public class Hit
    {
        ...
        public ElasticLanguageData _source { get; set; }
