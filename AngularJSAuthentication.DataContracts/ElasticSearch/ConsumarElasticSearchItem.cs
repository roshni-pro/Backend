...
namespace AngularJSAuthentication.DataContracts.ElasticSearch
{
    ...
    public class ConsumerItem
    {
        ...
        public List<MrpMedia> MrpMedias { get; set; }

    }

    public class ConsumarElasticSearchItem
    {
        public int id { get; set; }
        public int itemid { get { return id; } }
        public int basecategoryid { get; set; }
        ...
        public double Score { get; set; }
        public double Rating { get; set; }
        public List<ElasticSearchItemMultiMrps> ItemMrps { get; set; }
    ...
    public class ElasticSearchItemMultiMrps
    {
        public bool active { get; set; }
        public int itemid { get; set; }
        [Keyword]
    ...
    public class ItemWarehouseType
    {
        public int WarehouseId { get; set; }
        public string ItemNumber { get; set; }
